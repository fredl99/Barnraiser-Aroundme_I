...
<ul>
	<li><a href="#tag_builder" onclick="javascript:loadPluginTagBuilder('plugins/barnraiser_contact/block_tag_builder.php?tag=email');">Create email contact form</a></li>
</ul>


<script type="text/javascript">

function buildPluginBarnraiserContactTag(name) {
	tag = '<AM_BLOCK plugin="barnraiser_contact" name="'+name+'" ';
